...
/*宽7像素，高12像素 新宋体*/
const uint8_t oled_font_7x12[][14] = {
    ...
    {0xC0, 0x20, 0x20, 0xC0, 0x00, 0x00, 0xE0, 0x01, 0x00, 0x00, 0x00, 0x01, 0x01, 0x00}, /*"~",94*/
};
...
/*宽12像素，高12像素 GBK/GB2312*/
const OLED_Character_t oled_Cfont_12x12[] = {

"温",{0x00,0x08,0xD2,0x00,0xDE,0x5A,0xDA,0xDA,0x5A,0x5E,0xC0,0x00,0x00,0x07,0x00,0x04,0x07,0x04,0x07,0x07,0x04,0x04,0x07,0x00},/*"温",0*/
"度",{0x00,0xC0,0x3C,0x94,0x94,0xBC,0xD3,0xD4,0xBC,0x14,0x12,0x00,0x00,0x07,0x04,0x04,0x04,0x05,0x02,0x02,0x05,0x04,0x04,0x00},/*"度",1*/
"当",{0x00,0x10,0xA6,0xAC,0xA0,0xA0,0x9F,0xA0,0xA8,0xA6,0xE2,0x00,0x00,0x02,0x02,0x02,0x02,0x02,0x02,0x02,0x02,0x02,0x07,0x00},/*"当",2*/
"前",{0x04,0xE4,0x54,0x55,0x56,0xF4,0x04,0xF4,0x07,0xF4,0x04,0x04,0x00,0x07,0x01,0x01,0x05,0x07,0x00,0x01,0x04,0x07,0x00,0x00},/*"前",3*/
"预",{0x00,0x02,0xFA,0x26,0x62,0x02,0xFA,0x8E,0x6A,0x0A,0xFA,0x00,0x00,0x04,0x07,0x00,0x00,0x04,0x05,0x03,0x02,0x02,0x04,0x00},/*"预",4*/
"设",{0x00,0x10,0xF2,0x00,0x30,0x6E,0xA2,0x22,0xBE,0x70,0x10,0x00,0x00,0x00,0x07,0x07,0x05,0x04,0x03,0x03,0x03,0x04,0x04,0x00},/*"设",5*/
"湿",{0x00,0x53,0xA2,0x44,0xBE,0x2A,0xEA,0x2A,0xEA,0x2A,0xFE,0x00,0x00,0x07,0x00,0x04,0x05,0x04,0x07,0x04,0x07,0x06,0x05,0x00},/*"湿",6*/
    /*按照上面的格式，在这个位置加入新的汉字数据*/

    /*未知字符 框框内加问号*/
    "",
    {0x00, 0xFE, 0x02, 0x32, 0x0A, 0x0A, 0x8A, 0x4A, 0x32, 0x02, 0xFE, 0x00, 0x00, 0x07, 0x04, 0x04, 0x04, 0x04, 0x06, 0x04, 0x04, 0x04, 0x07, 0x00}, /*"默认",x*/
};

/*宽16像素，高16像素 GBK/GB2312*/
const OLED_Character_t oled_Cfont_16x16[] = {
    ...
    "世",
    {0x20, 0x20, 0x20, 0xFE, 0x20, 0x20, 0xFF, 0x20, 0x20, 0x20, 0xFF, 0x20, 0x20, 0x20, 0x20, 0x00, 0x00, 0x00, 0x00, 0x7F, 0x40, 0x40, 0x47, 0x44, 0x44, 0x44, 0x47, 0x40, 0x40, 0x40, 0x00, 0x00}, /*"世",2*/
    "界",
    {0x00, 0x00, 0x00, 0xFE, 0x92, 0x92, 0x92, 0xFE, 0x92, 0x92, 0x92, 0xFE, 0x00, 0x00, 0x00, 0x00, 0x08, 0x08, 0x04, 0x84, 0x62, 0x1E, 0x01, 0x00, 0x01, 0xFE, 0x02, 0x04, 0x04, 0x08, 0x08, 0x00}, /*"界",3*/

    /*按照上面的格式，在这个位置加入新的汉字数据*/

    /*未知字符 框框内加问号*/
    "",
    {0x00, 0xFE, 0x02, 0x02, 0x72, 0x1A, 0x0A, 0x0A, 0x0A, 0x8A, 0x72, 0x02, 0x02, 0x02, 0xFE, 0x00, 0x00, 0x7F, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x57, 0x40, 0x40, 0x40, 0x40, 0x40, 0x7F, 0x00}, /*"默认",x*/
};
